...
IGNORE_INDEX = -100
# DEFAULT_TOKENS = {'pad_token': '[PAD]', 'eos_token': '<|end_of_text|>', 'bos_token': '<|begin_of_text|>', 'unk_token': '<unk>'}
DEFAULT_TOKENS = {'pad_token': '[PAD]', 'eos_token': '<|endoftext|>', 'bos_token': '<|beginoftext|>', 'unk_token': '<unk>'} # Qwen
# DEFAULT_TOKENS = {'pad_token': '[PAD]', 'eos_token': '</s>', 'bos_token': '<s>', 'unk_token': '<unk>'} # Mistral
# DEFAULT_TOKENS = {'pad_token': '<pad>', 'eos_token': '<eos>', 'bos_token': '<bos>', 'unk_token': '<unk>'} # gemma3
...
for name, delm in DELIMITERS.items():
    ...
    PROMPT_FORMAT[name]["prompt_input_inst_part"]    = SYS_INPUT   + delm[0] + "\n{instruction}\n\n"
    PROMPT_FORMAT[name]["prompt_input_inpt_part"]    = delm[1] + "\n{input}\n\n" + delm[2] + "\n"

TEST_INJECTED_WORDS = ['Hacked', 'Hello World', 'Serendipity']
TEST_INJECTED_WORD = TEST_INJECTED_WORDS[2]
